[Github Trending Scraper](https://apify.com/nexgendata/github-trending-scraper?fpr=data)

> Extract trending repos from GitHub — daily, weekly & monthly trending by language. Track emerging open source projects, discover tools & monitor the developer ecosystem. Pay per result.
...
```
curl -X POST "https://api.apify.com/v2/acts/nexgendata~github-trending-scraper/run-sync-get-dataset-items?token=YOUR_TOKEN" \
...
- **Actor Start:** $0.0050
- **Trending repo:** $0.0030

## 🔗 Related NexGenData Actors

- [Hacker News Scraper](https://apify.com/nexgendata/hacker-news-scraper?fpr=2ayu9b)
- [WCAG Accessibility Auditor](https://apify.com/nexgendata/wcag-accessibility-auditor?fpr=2ayu9b)
